...
public class Waypoint
{
     ...
     * Почему можно не переопределять методы equals и hashCode для класса Waypoint?
     * Потому что экземпляры этого класса не используются в качестве ключа в HashMap
     * **/
    Location loc;
